...
//  DetectSilence
//
//  Created by Tianyi Ni on 29/04/2017.
//  Copyright © 2017 Tianyi Ni. All rights reserved.
//
 ...
 */
string OPENCV_ROOT = "/usr/local/Cellar/opencv/2.4.13.2/lib/";
...
string MOUTH_CASCADE_NAME = OPENCV_ROOT +"Mouth.xml";
string HAND_CASCADE_NAME = OPENCV_ROOT + "Hand.xml";
